  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const heading = [
        [
          {
            value: "Seller profile &  product list",
      ...
      const specification = {
        ...
        unitInStock: {
          displayName: "Inventory available",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        certificateArr: {
          displayName: "Certifications Of Product",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        productInstallation: {
          displayName: "Installation required",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
      ...
      try {
        const report = excel.buildExport([
          ...
          {
            name: "Seller profile product list", // <- Specify sheet name (optional)
