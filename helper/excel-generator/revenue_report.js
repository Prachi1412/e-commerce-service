...
near_by_member_export.makeExcelSheetWithData = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const heading = [
        [{ value: "Revenue Report", style: styles.headerDark }],
        [],
      ...
      const specification = {
        ...
        productPrice: {
          displayName: "Base Price Of Product",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        totalPrice: {
          displayName: "Seller sales value",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
      ...
      try {
        const report = excel.buildExport([
          ...
          {
            name: "Revenue Report", // <- Specify sheet name (optional)
