...
near_by_member_export.makeExcelSheetWithData = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const heading = [
        [{ value: " Service list", style: styles.headerDark }],
        [],
      ...
      const specification = {
        ...
        timeToInitiateService: {
          displayName: "Time to initiate the service",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        customizationAvailable: {
          displayName: "Service Customization Available",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        preRequisiteOffering: {
          displayName: "Pre-requisites for offering service ",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        awardRecognition: {
          displayName: "Awards & Recognitions received",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        otherInformation: {
          displayName: "Any additional information on service",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        durationOfService: {
          displayName: "Duration of the service",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
      ...
      try {
        const report = excel.buildExport([
          ...
          {
            name: "Service Report", // <- Specify sheet name (optional)
