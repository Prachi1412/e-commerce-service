...
near_by_member_export.makeExcelSheetWithData = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const heading = [
        [{ value: " Buyer list", style: styles.headerDark }],
        [],
      ...
      const specification = {
        ...
        accountUpgradeStatus: {
          displayName: "Account Upgrade Status",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
        ...
        typeOfHospitalValue: {
          displayName: "Type Of Hospital Value",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          //    cellStyle: styles.cellPink, // <- Cell style
          cellFormat: function (value, row) {
      ...
      try {
        const report = excel.buildExport([
          ...
          {
            name: "Buyer Report", // <- Specify sheet name (optional)
