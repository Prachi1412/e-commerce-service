...
near_by_member_export.makeExcelSheetWithData = async (
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const heading = [
        [{ value: "Query Resolution", style: styles.headerDark }],
        [],
      ...
      const specification = {
        ...
        dateOfResoluton: {
          displayName: "Date Of Resolution",
          headerStyle: styles.cellHeaderTheme,
          cellStyle: styles.cellCenter, // <- Cell style
          cellFormat: function (value, row) {
            // <- Renderer function, you can access also any row.property
      ...
      try {
        const report = excel.buildExport([
          ...
          {
            name: "Query Resolution  Report", // <- Specify sheet name (optional)
